...
(def messages
  {:stale-revision "The draft changed. Review the current choices and try again."
   ...
   :missing-loadout "That saved loadout no longer exists."
   :invalid-name "Enter a name for the loadout."
   :stale-catalog "This saved loadout no longer matches the current catalog."
   :invalid-assignments "This saved loadout has incompatible assignments."
