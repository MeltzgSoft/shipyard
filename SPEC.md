...
uses yaw around Y, pitch around X and roll around Z, in YXZ order, but persists a
normalized quaternion so repeated edits do not accumulate Euler conversion error.
Missing orientation metadata means identity for backward compatibility.
